...
#define KEY_TRACKPOINT_LEFT		KEY_LEFT
#define KEY_TRACKPOINT_RIGHT		KEY_RIGHT
#define KEY_TRACKPOINT_TOP		KEY_UP
#define KEY_TRACKPOINT_BOTTOM		KEY_DOWN
 ...
 */
	...
	/* Eliminate jitter */
	/* max_rel_value = max(abs(rel_x), abs(rel_y)); */

	/* if (max_rel_value > 2) { */
	/* 	if (max_rel_value == abs(rel_x)) { */
	/* 		if (rel_x > 0) { */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_RIGHT, 1); */
	/* 			input_sync(dev); */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_RIGHT, 0); */
	/* 			input_sync(dev); */
	/* 		} else if (rel_x < 0) { */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_LEFT, 1); */
	/* 			input_sync(dev); */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_LEFT, 0); */
	/* 			input_sync(dev); */
	/* 		} */

	/* 	} else { */
	/* 		if (rel_y > 0) { */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_BOTTOM, 1); */
	/* 			input_sync(dev); */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_BOTTOM, 0); */
	/* 			input_sync(dev); */
	/* 		} else if (rel_y < 0) { */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_TOP, 1); */
	/* 			input_sync(dev); */
	/* 			input_event(dev, EV_KEY, KEY_TRACKPOINT_TOP, 0); */
	/* 			input_sync(dev); */
	/* 		} */
	/* 	} */
	/* } */
	...
	/*report rel*/
	/* printk(KERN_ALERT"psmouse report rel X:%d\n", rel_x); */
	/* printk(KERN_ALERT"psmouse report rel Y:%d\n", rel_y); */ 

	psmouse_dbg(psmouse,"psmouse report rel X:%d\n", rel_x);
	psmouse_dbg(psmouse,"psmouse report rel Y:%d\n", rel_y);
...
static void psmouse_apply_defaults(struct psmouse *psmouse)
{
	...
	__set_bit(KEY_TRACKPOINT_LEFT, input_dev->keybit);
	__set_bit(KEY_TRACKPOINT_RIGHT, input_dev->keybit);
	__set_bit(KEY_TRACKPOINT_TOP, input_dev->keybit);
	__set_bit(KEY_TRACKPOINT_BOTTOM, input_dev->keybit);
